...
class Haus_gui():
    ...
    def makeHaus(self):
        self.h = {}
        self.h['hausImg'] = self.image_haus
        self.h['width'] = self.image_haus.get_width()
        self.h['height'] = self.image_haus.get_height()
        self.h['x'] = randint(0,1000)
        self.h['y'] = randint(0,1000)
    ...
    def blit(self):
        for i in self.hausList:
            ...
            self.screen.blit(self.image_haus,self.h['Rect'])
